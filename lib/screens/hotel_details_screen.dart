...
class _HotelDetailsScreenState extends State<HotelDetailsScreen> {
  ...
  Future<void> _selectDateAndBook(BuildContext context, Hotel hotel) async {
    ...
    if (picked != null) {
      ...
      String userID = Global.storageService.getString(AppConstants.STORAGE_USER_UID_KEY);
      var document = db.collection("users_reservations").doc(userID).collection('reservations').doc();
      document.set({
        'id': document.id,
        'title': hotel.title,
        'type': 'Hotel',
